...
# AWS_REGION="eu-west-3"
# AWS_PROFILE="Lington"
# CLUSTER_NAME="staging-demo-eks"   # <- change if your cluster name is different

# ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

# echo "==============================================="
# echo "  EKS FULL SETUP: S3 + Terraform + K8s + HPA + CA"
# echo "==============================================="
...
# # --- 6) Apply Kubernetes objects: Namespaces, App, HPA, Autoscaler ---
